...
A vulnerability in libcue discovered in 2023 made it possible to hack anyone using the popular GNOME desktop environment for Linux by tricking them into downloading one malicious file with no further interaction required.
